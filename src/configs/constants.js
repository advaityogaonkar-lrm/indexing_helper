export const initialConfigTemplate = (treeroot, url) => {
  ...
  <Sinequa>
	...
	<IncludedExtensions>html;htm;xlsx;xls;xlsm;doc;docx;doc;ppt;pdf</IncludedExtensions>
	...
	<Mapping>
		...
		<Description></Description>
		<Selection>doc.fileext = "pdf"</Selection>
	</Mapping>
	<UrlAccess>
...
export const finalConfigValues = {
  ...
  Url: "",
  IncludedExtensions: "",
  Mapping: [{ Name: "id", Value: "doc.url1" }],
